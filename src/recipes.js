...
const recipes = [
  {
    name: 'Bluefish Pâté Bagel with Avocado',
    picture: BagelAvocado,
    id: 1,
    ingredients: [
      'Bagels',
      ...
      'feta cheese',
      'Avocado',
      'Pickeled Onions and Jalepenós',
      'Hot Sauce',
    ],
    instructions: [
      'Start off by making sure you get fresh bagels (this is a MUST for maximum delicious-ness), and toast them well to get a nice crispy inside!  This will help to keep a contrasting texture to all of the other ingredients',
      'Spread a healthy layer of Bluefish Pâté on each slice of your bagel and spinkle a bit of feta cheese over top of it',
      'Next, dice up some fresh spinach and toss in a bit of the juice from your pickled jalepènos for a bit of extra bite',
      'Finally garnish with pickeled jalepènos and pickled onion, serve with a side of avocado and with salt, pepper, and your choice of hotsauce and get ready to get your day started with a healthy and incredible breakfast!',
    ],
  },
  {
    name: 'Gumbo',
    ...
    ingredients: [
      ...
      '3 teaspsoons kosher salt, divided',
      ...
      '1 pound andouille sausage, bite sized pieces',
      'rice for serving',
  ...
  },
  {
    ...
    id: 3,
    ingredients: [
      '1 unbaked 9-inch crist, frozen for at least 30min',
      '2 cups pecans, coarsley chopped, (save some for decoration before backing',
  ...
  {
    name: 'Gochujang Shortribs',
    picture: ShortRibs,
    id: 4,
    ingredients: [
      '3lbs bone-in beef shortribs',
      '3/4 cup soy sauce',
      ...
      '2/3 teaspsoon korean red chili flakes',
      '4 - 5 tablespoons gochujang (more if you want it spicier)',
    ...
    instructions: [
      ...
      'set oven to 350°F and place in ribs on foil lined backing sheet until ribs are throughly cooked through and meat is falling from the bone',
      'baste ribs in sauce and wrap in tin foil for 10 - 15min (ribs will continue to heat in tin foil and become more juicy)',
      'sprinkle with sesame seeds and green onion and plate!  Get ready for some for the best ribs you\'ve ever had!',
    ],
  },
  {
    name: 'Chashu',
    ...
    instructions: [
      ...
      'Transfer the seared chashu to the Dutch oven with all liquids and ingredients for sauce',
      'Simmer on low heat, and cover with the otoshibuta at all times for the next 2 hours, turning the chashu every 30 minutes. The sauce has been reduced. After 2 hours, turn off the heat to let it cool a little bit. rest overnight!',
    ],
  },
  {
    name: 'Cinnamon Rolls',
    picture: CinnamonRolls,
    id: 6,
    ingredients: [
      '-----DOUGH-----',
      '3/4 cup warm 2% milk',
      ...
      '3 cups bread flower and more for dusting',
      '3/4 tablespoon of salt',
      '-----FILLING-----',
      '2/3 cup brown sugar',
      '1 1/2 tabletspoon ground cinnamon',
  ...
  {
    name: 'Hoosier Tenderloin',
    picture: HoosierTenderloin,
    id: 7,
    ingredients: [
      '2 lbs center cut boneloess pork loin',
      '2 large eggs',
      '2 cups buttermilk',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '2 reb bell pepper diced and seeded',
  ...
  },
  {
    ...
    ingredients: [
      ...
      '2 rip tomatoes puréed',
      '1/4 cup dry white wine',
      '2 cups shrimp stock',
      '3 bay leaves',
      '3 tablespoons crystal hotsauce',
      '1 - 2 lbs shrimp',
    ...
    instructions: [
      ...
      'Add the shrimp and bring back to a simmer.',
